...
ULONG findProcess(char* name)
{
	...
	{
		ULONG64 nextProcess = ((ULONG64)(plistProcess)) - 0x448;
	...
	PUNICODE_STRING RegisterPath)
{
	...
	findProcess("System1");
	g_PTE_BASE = 0xFFFF9A8000000000;//*(PULONG64)(g_NT_BASE + 0xCB3C);
